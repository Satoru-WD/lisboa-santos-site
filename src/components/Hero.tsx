          ...
          >
            ...
            <div className="flex items-center gap-4 pt-2">
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
                className="group inline-flex items-center gap-3 px-8 py-4 bg-accent text-white font-bold rounded-full shadow-xl shadow-accent/25 hover:bg-accent/90 transition-all text-base"
              >
                <WhatsAppIcon />
              ...
              <a
                href="#diagnostico"
                className="text-sm font-semibold text-text-secondary hover:text-primary transition-colors underline-offset-4 hover:underline"
              >
      ...
      <div className="flex flex-col lg:hidden min-h-screen">
        ...
        >
          ...
          <div className="flex flex-col w-full max-w-xs gap-3 pt-2">
            <a
              href="#contato"
              className="inline-flex items-center justify-center gap-2 w-full px-6 py-4 bg-accent text-white font-bold rounded-full shadow-lg shadow-accent/25 text-base"
            >
              <WhatsAppIcon />
              Falar com especialista
            </a>
            <a
              href="#diagnostico"
              className="inline-flex items-center justify-center gap-2 w-full px-6 py-3.5 bg-white text-primary font-semibold rounded-full border-2 border-border text-sm hover:bg-slate-50 transition-colors"
            >
              Solicitar diagnóstico gratuito
            </a>
          </div>
