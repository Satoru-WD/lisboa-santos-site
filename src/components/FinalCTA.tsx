            ...
            <div className="p-10 md:p-14 space-y-8">
              ...
              <div className="space-y-3">
                <motion.a 
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-accent text-white font-bold rounded-full hover:bg-accent/90 transition-all shadow-xl shadow-accent/20 w-full text-base"
                >
                  <WhatsAppIcon />
                ...
                <a 
                  href="#diagnostico"
                  className="block text-center text-sm text-text-secondary hover:text-primary transition-colors py-2"
                >
                  Prefiro solicitar por formulário <ArrowRight size={14} className="inline ml-1" />
                </a>
              </div>
